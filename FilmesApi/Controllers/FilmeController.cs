...
public class FilmeController : ControllerBase
{
    ...
    [HttpGet]
    public IEnumerable<ReadFilmeDto> RecuperaFimes
    (
    ...
    {
        if(nomeCinema == null){ 
            return _mapper.Map<List<ReadFilmeDto>>(_context.Filmes.Skip(skip).Take(take).ToList());//Pulo 'skip' registros e retorno 'take' registros
        }
        ...
        ).ToList());//Pulo 'skip' registros e retorno 'take' registros
    }
